...
# # Xuất CSV
# top_customers.to_csv("top_khach_hang.csv", encoding="utf-8-sig")
...
# combined = pd.concat(result, axis=1)
# combined.to_csv("phan_tich_ket_hop.csv", encoding="utf-8-sig")
...
# combined = pd.concat(result, axis=1)
# combined.to_csv("phan_tich_crosstab.csv", encoding="utf-8-sig")
...
# combined = pd.concat(result, axis=1)
# combined.to_csv("phan_tich_doanh_thu.csv", encoding="utf-8-sig")