...
plt.savefig("outputpng/so_tien_mua_hang.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/chi_tieu_theo_gioi_tinh.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/chi_tieu_theo_tuoi.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/danh_muc_san_pham.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/phuong_thuc_thanh_toan.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/chi_tieu_theo_danh_muc.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/doanh_thu_theo_danh_muc.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/chi_tieu_theo_mua.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/chi_tieu_subscription.png", dpi=250, bbox_inches='tight')
plt.show()
...
plt.savefig("outputpng/boxplot_chi_tieu_gioi_tinh.png", dpi=250, bbox_inches='tight')
plt.show()